...
const WomenClothesSlider = () => {
  return (
    <div className="w-full flex justify-center my-12">
      <div className="w-[92%] sm:w-[95%] md:w-[90%] lg:w-[85%] xl:w-[80%] bg-white rounded-2xl shadow-sm p-3">
        ...
        <div className="flex lg:hidden flex-col justify-center items-center bg-gradient-to-b from-rose-600 to-rose-500 rounded-2xl text-white p-5 mb-5 text-center shadow-md">
          <h3 className="text-lg font-semibold mb-3">پوشاک زنانه</h3>
          <p className="text-sm mb-4 opacity-90">جدیدترین و پرفروش‌ترین لباس‌های زنانه</p>
  ...
  <h3 className="text-xl font-semibold mb-4">پوشاک زنانه</h3>
  <p className="text-sm mb-4 opacity-90">جدیدترین و پرفروش‌ترین لباس‌های زنانه</p>
          ...
          <div className="lg:col-span-4 overflow-hidden">
            ...
            >
              {products.map((p) => (
                <SwiperSlide
                  key={p.id}
                  className="!w-[160px] sm:!w-[180px] md:!w-[200px] lg:!w-[220px] flex justify-center"
                >
...
export default WomenClothesSlider;
